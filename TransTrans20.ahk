...
logFileTimestampsFromStartChecked := false
mainWindowPos := ""
debugWindowPos := ""
...
Gui, Add, CheckBox, x82 y221 gTimestampCheck vTimestampCheck Checked1, Timestamps
...
Gui, Add, CheckBox, x163 y221 gTimestampsFromStartCheck vTimestampsFromStartCheck Checked0, From Start
...
gui,submit,nohide ;updates gui variable
logFileTimestampsFromStartChecked := TimestampsFromStartCheck
return
...
SaveSettings()
{
 ...
 iniFile.Set("logFileTimestampsFromStartChecked", "Options", logFileTimestampsFromStartChecked)
...
global
 ...
 logFileTimestampsFromStartChecked := iniFile.Get("logFileTimestampsFromStartChecked", "Options", default_value = logFileTimestampsFromStartChecked)
 
 GuiControl,, FileEdit, % directory
 GuiControl,, FileEnabledCheck, % logFileEnabled
 GuiControl,, TimestampCheck, % logFileTimestamps
 GuiControl,, TimestampsFromStartCheck, % logFileTimestampsFromStartChecked
